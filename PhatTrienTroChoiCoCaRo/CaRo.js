...
class GameBoard {
    ...
    check(x, y) {
        ...
        let count = 1
        let i = 1
        while (y + i < this.cols && this.cells[x][y + i] === cell.value) {
            count++
            i++
        }
        i = 1
        ...
        count = 1
        i = 1
        while (x - i >= 0 && this.cells[x - 1][y] === cell.value) {
            count++
            i++
        }
        this.endGame(count)
        ...
        count = 1
        i = 1
        while (x + i < this.cols && y - i >= 0 && this.cells[x + i][y - i] === cell.value) {
            count++
            i++
        }
        count = 1
        i = 1
        while (x - i >= 0 && y + i < this.cols && this.cells[x - i][y + i] === cell.value) {
            count++
            i++
        }
        this.endGame(count)
        ...
        count = 1
        i = 1
        while (x + i < this.cols && y + i < this.cols && this.cells[x + i][y + i] === cell.value) {
            count++
            i++
        }
        count = 1
        i = 1
        while (x - i >= 0 && y - i >= 0 && this.cells[x - i][y - i] === cell.value) {
            count++
            i++
        }
        this.endGame(count)
...
function start(){
    gameBoard= new GameBoard(DEFAULT_COLS,DEFAULT_ROWS,"gameBoard")
    gameBoard.draw()
}
